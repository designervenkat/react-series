function Home() {
    return (
        <div className="h-screen bg-gray-200 grid place-content-center w-full">
    ...
    // // babel - transpile this entire code in javascript
    // return React.createElement(
    //     'div',
    //     { id: 'title', className: 'something' },
    //     React.createElement('h1', null, 'Hello React From JS')
    // )
}
